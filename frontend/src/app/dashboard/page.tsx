    ...
    <ProtectedRoute allowedRoles={['pelajar']}>
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="relative bg-white rounded-xl shadow-md p-6 border border-gray-100">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-full flex items-center justify-center text-2xl shadow-lg">
                    👋
                  </div>
                  <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        ...
                        <p className="text-indigo-100 text-sm">Level {gamificationStats.current_level} - {gamificationStats.level_name}</p>
                      </div>
                      <Link
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group relative bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 rounded-xl shadow-md p-6 border-2 border-blue-200/50 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 overflow-hidden">
                ...
                <div className="group relative bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 rounded-xl shadow-md p-6 border-2 border-green-200/50 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-white via-indigo-50/30 to-purple-50/20 rounded-xl shadow-lg p-6 border-2 border-indigo-100/50">
                ...
                <div className="mb-6">
                  <div className="w-full bg-gray-200 rounded-full h-4 mb-2 shadow-inner">
                    <div
                      className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 h-4 rounded-full transition-all duration-700 shadow-md relative overflow-hidden"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-white via-blue-50/40 to-indigo-50/30 rounded-xl shadow-lg p-6 border-2 border-blue-100/60">
